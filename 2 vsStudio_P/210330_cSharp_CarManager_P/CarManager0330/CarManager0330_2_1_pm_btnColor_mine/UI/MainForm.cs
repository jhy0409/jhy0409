...
namespace CarManager0323
{
    public partial class MainForm : MaterialForm
    {
        ...
        {
            new CarInForm(ora, dHandler, this).ShowDialog();
        }
        ...
        private void insertCustomer_Click(object sender, EventArgs e)
        {
            ...
            new CustInsForm(ora, dHandler, this).ShowDialog();
        }
        ...
        private void insertSeller_Click(object sender, EventArgs e)
        {
            ...
            new SellerInsForm(ora, dHandler,this).ShowDialog();
        }
        ...
        private void insertDeal_Click(object sender, EventArgs e)
        {
            ...
            UISymbolButton[] btn = getButton();
            Color c = Color.FromArgb(80, 160, 255);

            for (int i = 0; i < btn.Length; i++)
            {
                btn[i].FillColor = btn[i].RectColor = c;
            }
        }

        public UISymbolButton[] getButton()
        {
            UISymbolButton[] btn = { insertCar, insertCustomer, insertSeller };
            return btn;
        }
    }
}
